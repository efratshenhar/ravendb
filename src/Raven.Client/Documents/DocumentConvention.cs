...
namespace Raven.Client.Documents
{
    ...
    public class DocumentConvention : QueryConvention
    {
       ...
       public string GetDynamicTagName(object entity)
       {
        ...
        /// <returns></returns>
        public string GenerateDocumentKey(JsonOperationContext context, RequestExecuter requestExecuter, string dbName, object entity)
        {
            ...
            return DocumentKeyGenerator(context, requestExecuter, dbName, entity);
        }

        public Task<string> GenerateDocumentKeyAsync(JsonOperationContext context, RequestExecuter requestExecuter, string dbName,  object entity)
        {
            var type = entity.GetType();
            ...
            return AsyncDocumentKeyGenerator(context, requestExecuter, dbName, entity);
        }
      ...
      public Func<dynamic, string> FindDynamicTagName { get; set; }
        ...
        public Func<JsonOperationContext, RequestExecuter, string, object, string> DocumentKeyGenerator { get; set; }

        /// <summary>
        /// Gets or sets the document key generator.
        /// </summary>
        /// <value>The document key generator.</value>
        public Func<JsonOperationContext, RequestExecuter, string,  object, Task<string>> AsyncDocumentKeyGenerator { get; set; }
