...
namespace Raven.Server.Smuggler.Documents
{
    public class StreamSource : ISmugglerSource, IDisposable
    {
        ...
        private unsafe BlittableJsonReaderObject ConvertToBlob(BlittableJsonReaderObject values, ICounterActions actions)
        {
            ...
            try
            {
                JsonOperationContext context = actions != null ? actions.GetContextForNewDocument() : GetContextForNewDocument();
...
#pragma warning restore 618
        ...
        public Stream GetTempStream()
        {
            ...
            var tempStream = new StreamsTempFile(tempFileName, true);
            ToDispose.Add(tempStream);
            if (_options.EncryptionKey != null)
                return new DecryptingXChaCha20Oly1305Stream(tempStream.StartNewStream(), Convert.FromBase64String(_options.EncryptionKey));

            return tempStream.StartNewStream();
        }
